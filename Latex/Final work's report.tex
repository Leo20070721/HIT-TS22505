...
\ctexset{
	section={aftername=\hspace{1em},format=\heiti\centering\zihao{2}\mdseries, afterskip=0bp,beforeskip=0bp,},% 设置 section 标题为黑体、右对齐、小4号字
	subsection={aftername=\hspace{0.5em},format=\heiti\raggedright\zihao{-3}, afterskip=0bp,beforeskip=0bp,},% 设置 subsection 标题为黑体、5号字
...
%版芯设置/页边距设置
\usepackage{geometry}
\geometry{a4paper,left=3cm,right=3cm,top=2.85cm,bottom=2.85cm}

%页眉制作
\usepackage{fancyhdr}
\pagestyle{fancy}
%\fancyhf{}% 清除默认的页眉和页脚
\fancyhead[C]{\small\songti 哈尔滨工业大学本科结课报告}
\fancyhead[L]{}
\fancyhead[R]{}
\makeatletter %双线页眉
\def\headrule{{\if@fancyplain\let\headrulewidth\plainheadrulewidth\fi%
\hrule\@height 0.8pt \@width\headwidth\vskip1pt%上面线为1pt粗
...
%标题间距包
\usepackage{titlesec,kantlipsum}

%照片插入
\usepackage{graphicx, float}
\graphicspath{ {./PNG_files} }
\numberwithin{figure}{section} %按章分配图片编号

%伪代码书写
\usepackage[ruled,linesnumbered,lined,boxed,linesnumbered]{algorithm2e}

%封皮作者区
\renewcommand*{\Affilfont}{\large\heiti}
\renewcommand\Authands{ 与 } %将"and"修改为"与"
...
%内容区----------------------------------------------------------------------------------------------------------------
\begin{document}
\titleformat{\section}{\LARGE\centering\heiti}{第\arabic{section} 章}{0.5em}{\heiti}
\titlespacing{\section}{0cm}{10mm}{10mm}
\titleformat{\subsection}{\Large\heiti}{\arabic{section}.\arabic{subsection}}{0.5em}{\heiti}
\titlespacing{\subsection}{0cm}{7mm}{7mm}
\titleformat{\subsubsection}{\large\heiti}{\arabic{section}.\arabic{subsection}.\arabic{subsubsection}}{0.5em}{\heiti}
\titlespacing{\subsubsection}{0cm}{6mm}{6mm}
%封面--------------------------------------------------------
\pagestyle{empty}\maketitle\thispagestyle{empty}
%摘要--------------------------------------------------------
\newpage\setcounter{page}{1}\pagenumbering{Roman}\pagestyle{fancy}\begin{abstract}
